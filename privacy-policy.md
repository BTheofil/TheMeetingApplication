...
Nothing. The app has no accounts, no analytics, no advertising, and no crash reporting. Anything you create or change in the app stays on your device.
...
- an anonymous identifier it generates for your installation (not linked to your name or email)
...
If you never make a purchase, none of the above applies and nothing is sent anywhere.

## Why this data is processed

Purchase data is processed only to verify your purchase, keep it working across reinstalls and devices, and meet legal and tax obligations for the transaction. It is not used for advertising or profiling, and it is not sold or shared with anyone else.
